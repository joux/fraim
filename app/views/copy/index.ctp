...
<tr>
	...
	<th><?php echo $paginator->sort('original_id');?></th>
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action'=>'view', $copy['Copy']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action'=>'edit', $copy['Copy']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action'=>'delete', $copy['Copy']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $copy['Copy']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
